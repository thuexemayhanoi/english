...
- 981 published articles: the production plan is COMPLETE — cluster 14 (Vietnam travel by motorbike) published all 30 intents in Batch 26 (MM-0886-MM-0915, 2026-09-24 — see docs/matrix/batch-26-status.md; 4 transport comparisons (14.1), 6 city rental guides (14.2), 5 border/ownership guides (14.3), 15 nationwide travel guides (14.4)), on top of the 951 published across clusters 1-13 (cluster 13 completed in Batches 24-25 — see docs/matrix/batch-25-status.md and the earlier batch-status documents). All business facts come exclusively from docs/OWNER-FACTS.md.
- 14 topic hubs live, all with published guides; the vietnam-travel hub lists all 30 Batch 26 guides; trips hub lists all 38 trip guides (15 day-trip route guides, 8 trip-planning guides and 15 multi-day route guides; Batches 24-25), hanoi hub lists all 54 Hanoi travel guides, law-licences hub lists all 66 law articles, rental hub lists all 81 rental guides, monthly-rental hub lists all 45 monthly & long-term rental guides, safety hub lists all 55 safety guides, maintenance hub lists all 120 maintenance guides, parts-gear hub lists all 90 parts/gear guides, scooters hub lists all 110 scooter guides, motorcycles hub lists all 108 motorcycle guides, manual-clutch hub lists all 55 manual & clutch guides, 50cc hub lists all 40 50cc guides, electric hub lists all 89 electric guides.
...
1. Production plan COMPLETE: cluster 14 (Vietnam travel by motorbike) published all 30 intents 2026-09-24 in Batch 26 (MM-0886-MM-0915 — see docs/matrix/batch-26-status.md); clusters 13 and 14 completed in Batches 24-26. No approved strong intent remains unpublished (981 published articles; all 14 clusters COMPLETE). Remaining work is maintenance only: owner pruning passes for the documented P2/P3 warnings and periodic legal/travel fact re-review. Scheduled production runs must not start new article batches. Batch 25 published the 15 remaining multi-day cluster-13 trip intents (Mai Chau, Moc Chau, Ha Long/Cat Ba, Ha Giang, Cao Bang/Ban Gioc, Ba Be, Northeast loop, Northwest loop, Lang Son, Sapa, Pu Luong, Phong Nha, Hue, central coast Da Nang-Hoi An, first-mountain-trip comparison) on 2026-09-24 (MM-0871-MM-0885).
...
# MASTER MATRIX STATE
- docs/matrix/master-matrix.csv holds 981 committed rows after the batch-26 docs-sync merge (936 -> 951 -> 981; 981 published articles; the 15 batch-25 rows are preserved verbatim in docs/matrix/batch-25-rows.csv and the 30 batch-26 rows in docs/matrix/batch-26-rows.csv): 81 rental-cluster rows (81 published, cluster 1 complete), 45 monthly & long-term rental rows (45 published, cluster 2 complete), the complete 66-row cluster-11 law/licence slice (66 published; IDs renumbered to the unique LAW-0001-LAW-0066 range - see docs/matrix/batch-4-status.md), the complete 55-row cluster-10 safety slice (55 published, cluster 10 complete), 120 cluster-8 maintenance rows (120 published, cluster 8 complete), 90 cluster-9 parts/gear rows (90 published, cluster 9 complete), 110 cluster-3 scooter rows (110 published, cluster 3 complete), 108 cluster-4 motorcycle rows (108 published; cluster 4 COMPLETE: 106 planned intents plus 2 supplementary articles retained from the reconciled Batch 16 concurrent-run overlap), 55 cluster-5 manual & clutch rows (55 published; cluster 5 COMPLETE: 28 in Batch 17 plus 27 in Batch 18), 40 cluster-6 50cc rows (40 published; cluster 6 COMPLETE: all in Batch 19), 89 cluster-7 electric rows (89 published; cluster 7 COMPLETE: 50 in Batch 20 plus 39 in Batch 21) and 54 cluster-12 Hanoi travel rows (54 published; cluster 12 COMPLETE: 25 in Batch 22 plus 29 in Batch 23) and 38 cluster-13 trips rows (38 published; cluster 13 COMPLETE: 23 in Batch 24 plus 15 in Batch 25). The 988-intent plan in docs/MASTER-MATRIX.md remains the planning framework; rows for the remaining clusters are authored batch by batch, before each batch is written. Remaining rows are production candidates according to batch order (not approved for immediate wholesale publication).
...
- Batch 25 (cluster-13 trips Part 2, final): 15 multi-day articles published 2026-09-24 (MM-0871-MM-0885: Mai Chau, Moc Chau, Cat Ba/Ha Long, Ha Giang loop, Cao Bang/Ban Gioc, Ba Be, Northeast loop, Northwest loop, Lang Son, Sapa, Pu Luong, Phong Nha, Hue, Da Nang-Hoi An central coast, first-mountain-trip comparison; part-commits aec94fd, 4d95e93 and 2d29b2d, closing inbound-link commit 7553756 (12 existing articles)) - see docs/matrix/batch-25-status.md. 951 articles site-wide; cluster 13: 38 of 38 intents published, COMPLETE. Route/place facts verified per article in front-matter sources (retrieved 2026-09-24); business facts exclusively from OWNER-FACTS.
- Batch 24 (cluster-13 trips Part 1): 23 articles published 2026-09-24 (MM-0848-MM-0870: 15 day-trip route guides (13.1: Tam Dao, Ba Vi, Duong Lam, Thay/Tay Phuong pagodas, Perfume Pagoda, Co Loa, Bac Ninh craft loop, Dai Lai, Quan Son, Thung Nai, Ninh Binh, Soc Temple, Hung Kings, Nui Coc, and the Tam Dao vs Ba Vi comparison) and 8 trip-planning guides (13.3: trip-prep checklist, day-trip distance, seasons, navigation/offline maps, rural fuel/ATM/coverage, ferry/train transport, budgeting, overnight stays); part-commits c03d6f1, ba792d4, afb52cc, 452e01e and b67e548, wording repair 02dced2, rows/status commits 80ec1f1 and dbf7ef6, closing inbound-link commit 17e5864 (12 existing articles) with link repair c222f19, and QA link repair 58cde4b (truncated fog-slug in 2 articles - the cause of all earlier internal-link-audit gate failures) with rows follow-up 4afc5b6 - see docs/matrix/batch-24-status.md. 936 articles site-wide at the Batch 24 state; cluster 13 was completed by Batch 25 (38 of 38 intents). Route facts verified per article in front-matter sources; business facts exclusively from OWNER-FACTS.
...
- Batch 26 (cluster-14 Vietnam travel, cluster 14 COMPLETE, production plan COMPLETE): 30 articles published 2026-09-24 (MM-0886-MM-0915: 4 transport comparisons (14.1), 6 city rental guides (14.2), 5 border/ownership guides (14.3), 15 nationwide travel guides (14.4); part-commits 79f3994, 550b668, ee799d8, 4c876ef, 3678055 and d5b0a51, wording/source repair 44c278c, closing inbound-link commit 8aeed05 (14 existing articles)) - see docs/matrix/batch-26-status.md. 981 articles site-wide. Route/place facts cited per article in front-matter sources; border/legal-adjacent articles carry review_status review-required; business facts exclusively from OWNER-FACTS.
...
- Batch 26 (cluster-14 vietnam-travel, all 30 intents published, production plan COMPLETE): 30 articles published 2026-09-24 (MM-0886-MM-0915: 4 transport comparisons (14.1), 6 city rental guides (14.2), 5 border/ownership guides (14.3), 15 nationwide travel guides (14.4)) in part-commits 79f3994, 550b668, ee799d8, 4c876ef, 3678055, d5b0a51; wording/source repair 44c278c; closing inbound links 8aeed05 (14 existing articles); Quality Gate repair commits 5e56b1f (broken internal_link_targets in the parking guide) and a08cc0e (stray quotes in 6 internal_link_targets scalars after the 8aeed05 append - the root cause of the gate failures on the part commits). Verified: Quality Gate run 35964040750 (head a08cc0e) completed success; pages build and deployment run 35964040373 (head a08cc0e) completed success. 981 published articles site-wide; all 14 clusters COMPLETE. See docs/matrix/batch-26-status.md.
- Batch 25 (cluster-13 trips Part 2, MM-0871-MM-0885, cluster 13 COMPLETE) was published 2026-09-24 in part-commits aec94fd, 4d95e93 and 2d29b2d, closing inbound-link commit 7553756 (12 existing articles), and docs-sync tooling c3f1dd3. The Quality Gate on the first part-commit aec94fd failed because the cao-bang article forward-referenced northeast-vietnam-motorbike-loop before part 2 landed (a mid-batch forward-link miss, same pattern as Batch 24, fully resolved by the later part-commits). FINAL VERIFIED STATE: Quality Gate run 35958958319 on 7553756 - success (2026-09-24T05:14:16Z); pages build and deployment run 35958957980 on 7553756 - success (2026-09-24T05:15:07Z); Quality Gate run 35959187533 on c3f1dd3 - success (2026-09-24T05:17:29Z); Docs Sync run 35959187507 on c3f1dd3 - success, bot merge commit ccbe686 (master-matrix.csv 936 -> 951); Docs Sync run 35959344794 on d6a5f2a - success, bot verification-record refresh commit efd8dce (pages runs on the docs-only commits c3f1dd3 and ccbe686 were cancelled as superseded; content deployment is verified on 7553756). Live verification: /topics/trips/ lists 38 guides, and batch-25 article pages render live (e.g. /articles/ha-giang-loop-motorbike-guide/ and /articles/first-mountain-motorbike-trip-vietnam-comparison/). Remote MAIN holds 951 article files in _articles/ and all 15 batch-25 slugs verified present. Route/place facts verified per article in front-matter sources (retrieved 2026-09-24); business facts exclusively from OWNER-FACTS.
- Batch 24 (cluster-13 trips Part 1, MM-0848-MM-0870) was published 2026-09-24 in part-commits c03d6f1, ba792d4, afb52cc, 452e01e and b67e548, wording repair 02dced2, rows/status commits 80ec1f1 and dbf7ef6, closing inbound-link commit 17e5864 (12 existing articles), link repairs c222f19 (quoted internal_link_targets scalar in 5 articles) and 58cde4b (truncated slug fog-and-low-visibility-riding-motorbike-vietnam in 2 articles, the cause of all earlier internal-link-audit gate failures) with rows follow-up 4afc5b6, and docs-sync tooling 54e91e5. The Quality Gates on the part-commits failed at the internal-link audit until the 58cde4b repair. FINAL VERIFIED STATE: Quality Gate run 35954191800 on 58cde4b - success; Quality Gate run 35954199830 on 4afc5b6 - success (2026-09-24T04:07:20Z); Docs Sync run 35954225195 on 54e91e5 - success (its first merge attempt failed validation because 6 rows in batch-24-rows.csv had embedded newlines; diagnostics commit 7dfe727, rows repair 96666e0, retry 7248d1f); Docs Sync run 35954407188 on 7248d1f - success, bot merge commit c8b42a1 (master-matrix.csv 913 -> 936). Live verification: /topics/trips/ lists the 23 cluster-13 guides, /articles/ lists 936 guides, and batch-24 article pages render live (e.g. /articles/tam-dao-day-trip-motorbike/). Remote MAIN holds 936 article files in _articles/ and all 23 batch-24 slugs verified present.
