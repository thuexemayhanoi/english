...
- 14 topic hubs live; 4 currently show the empty state (Batch 18 completed the manual-clutch hub: 55 guides) ("Guides for this topic are being prepared."); the 50cc hub lists all 40 cluster-6 guides; law-licences hub lists all 66 articles, rental hub lists all 81 rental guides, monthly-rental hub lists all 45 monthly & long-term rental guides, safety hub lists all 55 safety guides, maintenance hub lists all 120 maintenance guides, parts-gear hub lists all 90 parts/gear guides, scooters hub lists all 110 scooter gui
...
1. 3 topic clusters have zero published articles (cluster 5 completed by Batches 17-18 and cluster 6 by Batch 19; remaining: electric, hanoi, trips, vietnam-travel — planned content, not a defect (planned content, not a defect — next up per MASTER-M
...
- Batch 19 (cluster-6 50cc, complete): 40 articles published 2026-09-24 (MM-0665-MM-0704: 7 understanding guides, 7 legal guides, 8 riding guides, 10 buying/owning guides, 4 maintenance guides, 4 gear/safety guides; part-commits f2147fe, 81bd7a0, eead9f6, a35b5a4, repairs d8d4ba5/67f7d5c, closing inbound-link commit 9ce5a03). 770 articles site-wide; cluster 6: 40 of 40 intents published, COMPLETE. Pre-batch research: Honda VN and Yamaha VN currently list no 50cc models, so no manufacturer rows exist and no model-specific 50cc facts were written (see docs/MODEL-DATABASE.md 50cc note); legal articles cite the verified Law 36/2024 + Decree 168/151 primary sources; business facts exclusively from OWNER-FACTS with contact-only 50cc availability. See docs/matrix/batch-19-status.md.
...
Batch 19 (cluster-6 50cc, complete) is published (2026-09-24): 40 articles (MM-0665-MM-0704; part-commits f2147fe, 81bd7a0, eead9f6, a35b5a4, repairs d8d4ba5/67f7d5c, closing inbound-link commit 9ce5a03), 770 published articles site-wide, cluster 6 COMPLETE: 40 of 40 intents. Pre-batch manufacturer research found no current official 50cc models at Honda VN or Yamaha VN, so no model rows were added to MODEL-DATABASE and no model-specific 50cc specs were written; legal facts come only from the verified Law 36/2024/QH15 + Decree 168/2024 and 151/2024 primary sources; business facts exclusively from OWNER-FACTS (50cc availability and pricing: contact only). Next per the MASTER-MATRIX production plan: cluster 7 (electric motorbikes and e-bikes, 89 intents — populate MODEL-DATABASE electric fields from manufacturer pages, incl. VinFast, first), then clusters 12-13 (hanoi, trips — R2 route verification) and cluster 14 (vietnam-travel).
