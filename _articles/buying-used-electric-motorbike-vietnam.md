---
title: "Buying a Used Electric Motorbike in Vietnam: The Battery Checklist"
slug: buying-used-electric-motorbike-vietnam
description: "A used electric motorbike is a used battery with wheels attached — how to check pack health, charge cycles, theft history and what a fair price looks like."
category: electric
tags:
  - "electric"
  - "used"
...
## Start with the battery, not the bike
...
- Frame, brakes, tyres and suspension wear like any bike's.
- Water damage: check connectors and the controller area for corrosion or flood residue.
- Charger included, and it is the manufacturer's own — substitutions age packs and void warranties.
- Papers: registration documents must match the frame number; battery serials should match the bike where the model tracks them.
