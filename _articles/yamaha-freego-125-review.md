---
title: "Yamaha FreeGo 125 Review: The Practical Sporty Scooter"
slug: yamaha-freego-125-review
description: "Yamaha FreeGo 125 review with verified specs from Yamaha Vietnam - Blue Core 124.9cc engine, 25-litre storage, SmartKey, LED headlight and 3-year warranty."
category: scooters
tags:
  - "yamaha freego"
  - "125cc scooter"
...
A Blue Core 124.9 cc single-cylinder, two-valve, SOHC engine with forced-air cooling and CVT. Official figures: maximum power 7.0 kW at 8,000 rpm, maximum torque 9.0 Nm at 5,500 rpm, published fuel consumption 2.03 litres/100 km from a modest 3.9-litre tank - the tank to plan fuel stops around on longer rides. Engine oil capacity is listed at 0.84 litres at oil change.
...
Front disc and rear drum brakes, LED headlight, smart key on current versions, a phone charging port, and a 3-year or 30,000 km warranty. An ABS-equipped FreeGo S version is also offered - see which scooters have ABS in Vietnam.

## Who it suits

Riders who want one affordable scooter that does the daily commute and the occasional weekend run with a full-face helmet stowed. If you are choosing inside Yamaha's own range, our Janus vs FreeGo comparison covers the differences; cross-shopping against Honda, our brand comparison maps the equivalents.
