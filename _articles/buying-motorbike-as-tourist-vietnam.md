---
title: "Buying a Motorbike in Vietnam as a Tourist: The Honest Guide"
slug: buying-motorbike-as-tourist-vietnam
description: "Should you buy a motorbike for your Vietnam trip? What a decent bike costs, the paperwork (bluecard, sales contract), pitfalls and what to check before riding away."
...
Real prices from dealer and market guides: a new Yamaha PG-1 lists at about 30,000,000 VND before registration taxes and papers; a new Honda Wave-class underbone costs somewhat less; and the used market runs from a few tens of millions of dong for tired semi-automatics to solid mid-range sums for a modern automatic scooter. The sub-10-million-dong backpacker special still exists — usually older, usually needing work, and (a direct warning from local mechanics) very often on fake or missing papers.
...
- Understand that formal registration in a foreigner's name involves proof-of-purchase documents and residence considerations; touring specialists document the process, and it is far harder on a two-week tourist visa than for residents.
- Beware the pre-2013 paperwork problem: local workshops report that many older bikes circulate with forged documents, and the only real test is a check with traffic police or the registration database.
...
- Any trip under about a month — the numbers and the paperwork both favour renting.
- Riders who cannot afford a mid-trip mechanical failure on a cheap bike; a rental from a real shop starts each day with a machine somebody else maintains, and breakdown support is built into the transaction (ours covers Hanoi and local use; ask before you ride far).
- Anyone who does not want to spend a day of a short trip at the police station checking a bluecard.

## If you do buy: the first hour of checks

Brakes (front and rear, pads and lever feel), chain and sprockets, tyre age and pressure, electrics (all lights, horn, indicators), engine oil colour, fuel tank and lines for leaks, steering-head play, and a cold start. Riding-buying guides all emphasise the test brake first: a bike that cannot stop is not cheap at any price. Then ride it slowly around the block and listen.

Our renting-vs-buying comparison runs the numbers for a typical long trip; and if you conclude renting is right for the Hanoi chapter of your travels, contact us to confirm current availability.
