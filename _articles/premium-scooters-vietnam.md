---
title: "Premium Scooters in Vietnam: SH, Vario, NMAX, XMAX and What You Pay For"
slug: premium-scooters-vietnam
description: "Premium scooters in Vietnam explained - verified manufacturer prices for Honda SH, SH Mode, Vario, Yamaha NMAX, NVX and XMAX, and what the money buys over mainstream models."
category: scooters
tags:
  - "honda sh"
  - "nmax"
...
## Verified premium prices (manufacturer suggested retail)

| Model | Listed from |
|---|---|
| Honda Vario 125 / 160 | 41,913,818 / 56,690,000 VND |
| Honda SH Mode 125 | 59,684,727 VND |
| Honda SH160i/125i | 76,670,182 VND |
| Yamaha NVX 155 VVA (ABS) | from 55,300,000 VND |
| Yamaha Lexi 155 VVA-ABS | from 48,500,000 VND |
| Yamaha NMAX | from 69,000,000 VND |
| Honda SH350i | 151,390,000 VND |
| Yamaha XMAX | 140,000,000 VND |
| Honda ADV350 | 166,190,000 VND |
...
- **Equipment:** ABS is standard or common in this tier ([ABS guide]({{ '/articles/which-scooters-have-abs-vietnam/' | relative_url }})), along with smart keys, LCD meters and USB charging.
...
Economy (bigger engines drink more - see the fuel comparison), lightness (an SH is far heavier to park than a Vision), or immunity from theft - premium bikes attract thieves, and parking in central Hanoi gets careful (our parking guide).

## Renting vs buying

Premium scooters depreciate hard, which is why [long-term renting vs buying comparison]({{ '/articles/renting-vs-buying-a-motorbike-hanoi/' | relative_url }}) matters at this price level. For renters: Nguyen Tu's published rates cover mainstream models; premium models are not price-published - contact us to confirm current availability before planning around one. For the current flagships, see our full SH160i/125i review, the Sh mode 125 review, and the direct SH Mode vs SH160i comparison.
