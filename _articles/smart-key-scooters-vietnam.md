---
title: "Smart Key Scooters: How Keyless Systems Work in Vietnam"
slug: smart-key-scooters-vietnam
description: "Smart key and keyless scooters explained - which verified models offer them in Vietnam, how the systems work, battery care and what happens when the fob dies."
category: scooters
tags:
  - "smart key"
  - "keyless"
...
A fob in your pocket broadcasts a low-power signal. When it is within range, the bike unlocks at a button press, the seat opens electrically and the engine start button works; when it leaves range, the bike immobilises. There is usually a physical backup key hidden in the fob for the seat and a PIN or emergency procedure for starting with a dead fob - learn the procedure before you need it, from the bike's own manual.
