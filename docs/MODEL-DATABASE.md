...
Notes (2026-09-23): kerb weights and dimensions recorded above as published by Honda VN (Vision 1,925 × 68
6
...
Values read from official Honda Vietnam and Yamaha Vietnam 
mo
...
| Honda Vario 160 | Honda VN | 2026 (current page) | automatic scooter | 156.9 | eSP+, 4-valve, liquid-cooled | 11.3 kW @ 8,500 rpm |
 14
...
## Verified manufa
cturer rows - Batch 12 additions (retrieved 2026-09-23)
...
| Yamaha Lexi 155 VVA-ABS | Yamaha VN | 2026 (current page) | automatic scooter | 155.1 | Blue Core, liquid-cooled, VVA | 11.3 kW @ 8,000 rpm | 14.2 Nm @ 6,500 rpm | CVT | 4.2 L | 2.19 L/100km | 768 mm | 118 kg | front disc ABS, rear drum | 90/90-14 front, 100/90-14 rear | (not published on retrieved page) | 48,900,000 VND (list, VVA-ABS premium version; from 48,500,000 VND across versions) | yamah
a-motor.com.vn/xe-may/lexi | 2026-09-23 | no | contact only |
...
vn/xe/sirius-rc | 2026-09-23 | class yes (Yamaha Sirius pricing approved) | OWNER-FACTS only |
...
## Verified manufacturer row — Yamaha VN PG-1 (retrieved 2026-09-24)

Values below were read from the Yamaha Motor Vietnam PG-1 2026 standard-version product page on 2026-09-24 (Batch 17 groundwork for the cluster 5 manual/semi-auto batch). Fields not published on the page are left EMPTY per rule 1. The PG-1 uses an automatic centrifugal clutch with a four-speed gearbox — it is a semi-automatic (xe so), not a manual-clutch bike.

| model | manufacturer | model_year | vehicle_type | engine_cc | engine_type | max_power | max_torque | transmission | fuel_system | fuel_tank | fuel_economy_claimed | seat_height | kerb_weight | brakes | tyre_sizes | storage | licence_class_vn | source_url | retrieved_at | in_fleet | pricing |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Yamaha PG-1 (standard 2026) | Yamaha VN | 2026 standard version | adventure-styled semi-automatic underbone | 113.7 | 4-stroke, 2-valve, SOHC, air-cooled, single (50.0 x 57.9 mm, 9.3:1) | 6.6 kW @ 7,000 rpm | 9.5 Nm @ 5,500 rpm | 4-speed, wet multi-plate automatic centrifugal clutch, electric start | electronic fuel injection, TCI ignition | 5.1 L | 1.76 L/100km (spec table; page highlight text cites 1.69 L/100km) | 795 mm | 107 kg (as listed on page) | front single hydraulic disc, rear drum | 90/100-16 front and rear, tubed, block pattern | damper under seat; no litres published | under 175 cc (A1 class) | yamaha-motor.com.vn/xe/pg-1-phien-ban-tieu-chuan-moi-2026-bns3/ | 2026-09-24 | no | contact only |

PG-1 page notes (retrieved 2026-09-24): dimensions 1,980 x 805 x 1,050 mm, wheelbase 1,280 mm, ground clearance 190 mm, front fork travel 130 mm, rear swingarm linkage suspension, engine oil capacity 0.8 L, battery 12V 3Ah, analogue speedometer with gear-position display, published warranty 3 years or 30,000 km. Retail price not displayed on the retrieved page — check Yamaha VN or a dealer for the current figure. Sirius line data from the same page family: Sirius FI from 21,306,000 VND with EFI and 1.65 L/100km; Sirius 2025 versions from 19,048,000 VND (drum, disc and alloy versions).
